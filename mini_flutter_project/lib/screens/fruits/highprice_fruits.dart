...
class HighPriceFruits extends StatefulWidget {
  const HighPriceFruits({super.key});

  @override
  State<HighPriceFruits> createState() => _HighPriceFruitsState();
}

class _HighPriceFruitsState extends State<HighPriceFruits> {
