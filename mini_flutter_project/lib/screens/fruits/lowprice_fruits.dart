...
class LowPriceFruits extends StatefulWidget {
  const LowPriceFruits({super.key});

  @override
  State<LowPriceFruits> createState() => _LowPriceFruitsState();
}

class _LowPriceFruitsState extends State<LowPriceFruits> {
