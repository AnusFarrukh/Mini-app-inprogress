...
import 'package:mini_flutter_project/screens/chickens/popular_chickens.dart';
import 'package:mini_flutter_project/screens/product_details.dart';

class HighPriceChickens extends StatefulWidget {
  const HighPriceChickens({super.key});

  @override
  State<HighPriceChickens> createState() => _HighPriceChickensState();
}

class _HighPriceChickensState extends State<HighPriceChickens> {
  ...
  List ProductData = [
    ...
    {'price': '\$10', 'name': 'Golden Piece', 'title': 'Fresh & Organic'},
