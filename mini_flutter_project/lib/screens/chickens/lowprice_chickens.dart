...
class LowPriceChickens extends StatefulWidget {
  const LowPriceChickens({super.key});

  @override
  State<LowPriceChickens> createState() => _LowPriceChickensState();
}

class _LowPriceChickensState extends State<LowPriceChickens> {
