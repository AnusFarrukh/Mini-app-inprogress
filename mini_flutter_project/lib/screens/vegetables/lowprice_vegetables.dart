...
class LowPriceVegetables extends StatefulWidget {
  const LowPriceVegetables({super.key});

  @override
  State<LowPriceVegetables> createState() => _LowPriceVegetablesState();
}

class _LowPriceVegetablesState extends State<LowPriceVegetables> {
