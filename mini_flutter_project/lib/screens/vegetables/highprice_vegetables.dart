...
import 'package:mini_flutter_project/screens/vegetables/popular_vegetables.dart';

class HighPriceVegetables extends StatefulWidget {
  const HighPriceVegetables({super.key});

  @override
  State<HighPriceVegetables> createState() => _HighPriceVegetablesState();
}

class _HighPriceVegetablesState extends State<HighPriceVegetables> {
