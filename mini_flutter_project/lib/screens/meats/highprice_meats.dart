...
class HighPriceMeats extends StatefulWidget {
  const HighPriceMeats({super.key});

  @override
  State<HighPriceMeats> createState() => _HighPriceMeatsState();
}

class _HighPriceMeatsState extends State<HighPriceMeats> {
